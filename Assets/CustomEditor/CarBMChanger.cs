...
public class CarBMChanger : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var info = new DirectoryInfo("assets/resources/cartextures");
        ...
        foreach (var file in fileinfo)
        {
            ...
            if (filestring.EndsWith(".png"))
            {
                ...
                tokens = last.Split('.');
                last = tokens[0];
                Texture tex = Resources.Load<Texture>("cartextures/" + last);
                r_Textures.Add(tex);
            }
    ...
    void Update()
    {
        ...
        if (counter > 10)
        {
            ...
            {
                if (material.name.Contains("Traffic-Car-Atlas"))
                {
